...
public class ExcelReaderFactory {
     ...
     * @throws EmptyFileException 空文件
     * @throws InvalidFormatException 格式错误
     */
    public static ExcelReader getExcelReader(InputStream in, Object customContent, AnalysisEventListener<?> eventListener) throws EmptyFileException, IOException, InvalidFormatException {
        return getExcelReader(in, customContent, eventListener, true);
    }
     ...
     * @throws InvalidFormatException 格式错误
     */
    public static ExcelReader getExcelReader(InputStream in, Object customContent, AnalysisEventListener<?> eventListener, boolean trim)
